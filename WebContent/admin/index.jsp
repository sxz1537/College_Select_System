...
<body style="height: 100%">
    ...
    <ul class="nav-left-container">
        <li>  
            <a href="infcount.jsp" target="rigrt_iframe">
        ...
        <li>
            ...
            <ul class="nav-left-container-small">
                ...
                <li>
                    <a class="J_menuItem" href="userlist.jsp" target="rigrt_iframe">用户列表</a>
                </li>
                <li>
                    <a class="J_menuItem" href="user_add.jsp" target="rigrt_iframe">添加用户</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul class="nav-left-container-small">
                <li>
                    <a class="J_menuItem" href="collegelist.jsp" target="rigrt_iframe">大学列表</a>
                </li>
                <li>
                    <a class="J_menuItem" href="college_add.jsp" target="rigrt_iframe">添加大学</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul class="nav-left-container-small">
                <li>
                    <a class="J_menuItem" href="majorlist.jsp" target="rigrt_iframe">专业列表</a>
                </li>
                <li>
                    <a class="J_menuItem" href="major_add.jsp" target="rigrt_iframe">添加专业</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul class="nav-left-container-small">
                <li>
                    <a class="J_menuItem" href="essaylist.jsp" target="rigrt_iframe">文章列表</a>
                </li>
                <li>
                    <a class="J_menuItem" href="essay_add.jsp" target="rigrt_iframe">添加文章</a>
                </li>
            </ul>
        </li>
        <li>
    ...
    <div style="margin-left: 300px; margin-top:30px;height: 800px">
